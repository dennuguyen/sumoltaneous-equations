...
class DistanceSensor {
   public:
    DistanceSensor(unsigned trigger_pin, unsigned echo_pin, float timeout_ms = 23529.4, float pulse_on_duration_ms = 10, float pulse_off_duration_ms = 2)
